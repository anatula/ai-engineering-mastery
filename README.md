...
| 6 | Stanford CS224N Lecture 1 | Stanford / Christopher Manning | Word embeddings (first 35 min) | 35 min | https://www.youtube.com/watch?v=zjkBMFhNj_g |
| 7 | Complete RAG Tutorial 2026 (Free Labs) | KodeKloud | Hands-on RAG with vector DBs | 60 min | https://www.youtube.com/watch?v=vT-DpLvf29Q |
| 8 | Introduction to Neural Networks and Deep Learning | MIT (YouTube) | Applied deep learning | 90 min | https://www.youtube.com/watch?v=kyQ0CRkYhy4 |
| 9 | Intro to Large Language Models [1hr Talk] | Andrej Karpathy | Remaining 40 min (capstone) | 40 min | https://www.youtube.com/watch?v=zjkBMFhNj_g |
...
|---|----------|-------|------|------|
| 1 | RNNs intuitively explained | Sequential data | 15 min | https://www.youtube.com/results?search_query=rnn+intuitively+explained |
| 2 | The Attention Mechanism (illustrated) | Key innovation | 20 min | https://www.youtube.com/results?search_query=attention+mechanism+illustrated |
| 3 | Transformers Explained Visually | Attention without recurrence | 25 min | https://www.youtube.com/results?search_query=transformers+explained+visually |
| 4 | Andrej Karpathy -- Let's build GPT | Hands-on transformer (first 45 min) | 45 min | https://www.youtube.com/watch?v=kCc8FmEb1nY |
| 5 | Attention is All You Need (paper explained) | Original 2017 paper | 20 min | https://www.youtube.com/results?search_query=attention+is+all+you+need+explained |

After Chapter 2: How transformers work and how to build a small GPT.

---

## Chapter 3: Agentic Coding and Local LLMs (Hands-On)

What agents are and how to build them locally. Includes prompt engineering (spec-driven development), function calling, quantization for running models on consumer hardware, and hands-on agent building.

| # | Resource | Author/Source | Topic | Time | Priority | Link |
|---|----------|---------------|-------|------|----------|------|
| 1 | Lecture 7: Agentic Coding | Missing Semester (MIT) | What are agents? (conceptual) | 60 min | Must | https://www.youtube.com/watch?v=sTdz6PZoAnw |
| 2 | AI Agents for Beginners -- Part 1 | KodeKloud | Hands-on: API calls, tools, workflows vs. agents | 60 min | Must | https://www.youtube.com/watch?v=MZhjki7t6p8 |
| 3 | Claude Code Essentials (short) | KodeKloud | Practical coding agent usage | 9 min | Must | https://www.youtube.com/watch?v=brLhhkUqcn4 |
| 4 | LLM function calling explained | YouTube search | How agents decide actions | 15 min | Must | https://www.youtube.com/results?search_query=llm+function+calling+explained+openai |
| 5 | Spec-Driven Development Workshop | Unlearn | Write structured specs, refine prompts, stop agents from guessing wrong | 120 min | Must | https://www.youtube.com/live/inKOU-ltbFc |
...
| 8 | Ollama tutorial (run Llama 3 locally) | YouTube search | Hands-on local LLMs | 15 min | Must | https://www.youtube.com/results?search_query=ollama+run+llama+3+locally+tutorial |
| 9 | Build a code agent from scratch | YouTube search | Hands-on open code | 60 min | Must | https://www.youtube.com/results?search_query=build+code+agent+from+scratch+python+langchain |
...
After Chapter 3: Prompt engineering (spec-driven), function calling, quantized local LLMs, memory/quality trade-offs, and basic coding agents.
...
| 2 | Multi-agent systems vs. single-agent loops | YouTube search | Planner-Worker patterns | 15 min | https://www.youtube.com/results?search_query=multi+agent+system+vs+single+agent+loop |
...
After Chapter 4: Why agent architecture matters more than model choice, and how multi-agent systems are structured.

---

## Chapter 5: Sandboxing and Security -- Letting Agents Run Free Safely

Most sandboxes focus on preventing writes. Reading SSH keys plus network access equals instant exfiltration. The spec-driven workflow from Chapter 3 defines security boundaries at the planning stage.
...
| 8 | RAG for codebases | How Cursor searches code | 20 min | https://www.youtube.com/results?search_query=rag+codebase+semantic+search |
| 9 | Merkle trees in 5 minutes | How Cursor avoids re-indexing | 10 min | https://www.youtube.com/results?search_query=merkle+tree+explained+in+5+minutes |
| 10 | Turbopuffer architecture (CEO interview) | Vector DB on object storage | 65 min | https://www.audible.in/podcast/Building-serverless-vector-search-with-Turbopuffer-CEO-Simon-Eskildsen/B0G27BLQZV |
...
| 2 | What is MCP? (conceptual deep dive) | Protocol overview | 20 min | https://www.youtube.com/results?search_query=what+is+mcp+model+context+protocol |
...
| 5 | MCP vs. Function Calling | Why MCP matters | 15 min | https://www.youtube.com/results?search_query=mcp+vs+function+calling |
...
| 3 | Build a custom Skill (Milvus RAG example) | Hands-on tutorial | Article | https://milvus.io/zh/blog/create-a-custom-anthropic-skill-for-milvus-to-quickly-spin-up-rag.md |
...
| Stanford CS224N Lecture 1 | https://www.youtube.com/watch?v=zjkBMFhNj_g |
...
| Resource | Link |
|----------|------|
| Lima (open-source VMs) | https://github.com/lima-vm/lima |
| Tart (CI sandboxing) | https://github.com/cirruslabs/tart |
| MCP Tutorial TypeScript | https://github.com/imzodev/mcp-tutorial-ts |
| Let's Learn MCP Python (Microsoft) | https://github.com/microsoft/lets-learn-mcp-python |
| Agent Skills specification | https://github.com/agentskills/agentskills |
| Skill-depot | https://github.com/Ruhal-Doshi/skill-depot |
| Advanced Context Engineering Prompts | https://github.com/marcaurelsecond/Advanced-Context-Engineering-for-AI-Agents |
...
| Build a custom Skill (Milvus) | https://milvus.io/zh/blog/create-a-custom-anthropic-skill-for-milvus-to-quickly-spin-up-rag.md |
...
2. Do the hands-on labs -- The KodeKloud videos include free sandboxes.
3. Run local LLMs -- After Chapter 3, install Ollama and experiment with quantized models.
4. Build something -- Use Chapter 8 to create an agent skill.
5. Watch the Spec-Driven Development Workshop in Chapter 4 -- It ties harness engineering and security together into a practical workflow.
6. Refer back -- The Pragmatic Engineer article on Cursor in Chapter 6 connects all the concepts to a real production system.

**Estimated total time:** 35-40 hours (excluding optional 12-hour deep dive).
...
- **Chapter 4:** Why agent structure matters more than the model, with a spec-driven workshop that includes OpenSec.
