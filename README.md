...
5 | Attention is All You Need (paper explained) | OYannic Kilcher| 35 min | https://www.youtube.com/watch?v=ZXuidhZKSGk
...
Hands-on building with LLMs: RAG pipelines, vector databases, prompt engineering (spec-driven development), function calling, and quantization for running models on consumer hardware.
...
6 | Spec-Driven Development Workshop | Unlearn | Write structured specs, refine prompts, stop agents from guessing wrong | 120 min | Must | https://www.youtube.com/live/inKOU-ltbFc
7 | OpenCode: Free and Local LLMs | Infralovers | Using Ollama, local models | Article | Must | https://www.infralovers.com/blog/2026-02-27-opencode-free-local-llms/
8 | Quantization Explained | SitePoint | 4-bit vs FP16 memory trade-offs | Article | Must | https://www.sitepoint.com/quantization-explained-q4km-vs-awq-vs-fp16-for-local-llms/
9 | Ollama tutorial (run Llama 3 locally) | YouTube  | Hands-on local LLMs | 15 min | Must | https://www.youtube.com/watch?v=WxYC9-hBM_g
10 | Build a code agent from scratch | YouTube  | Hands-on open code | 60 min | Must | https://www.youtube.com/watch?v=8fFH5e4WnPA
11 | Claude Code Deep Dive | Andrew Brown / freeCodeCamp | Comprehensive 12-hour course. Optional for daily users. | 12 hours | Optional | https://www.youtube.com/watch?v=brLhhkUqcn4
...
After Chapter 3: RAG pipelines, vector databases, prompt engineering (spec-driven), function calling, quantized local LLMs, memory/quality trade-offs, and basic coding agents.
